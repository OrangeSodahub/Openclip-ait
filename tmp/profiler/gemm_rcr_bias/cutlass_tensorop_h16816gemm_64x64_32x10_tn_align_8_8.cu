...
#define CUTLASS_CHECK(status)                                                         \
  ...
  using Operation_cutlass_tensorop_h16816gemm_64x64_32x10_tn_align8 = cutlass::gemm::device::GemmUniversal<
...
using GemmInstance = Operation_cutlass_tensorop_h16816gemm_64x64_32x10_tn_align8;
