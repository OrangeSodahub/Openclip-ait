...
#define CUTLASS_CHECK(status)                                                         \
  ...
  using Operation_cutlass_tensorop_h16816gemm_64x64_64x5_tn_align8 = 
...
using fa52ca5b86a2936232e8b42e2d0eda25fb91b621d = Operation_cutlass_tensorop_h16816gemm_64x64_64x5_tn_align8;
...
void gemm_rcr_bias_add_19 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 64 && N == 768 && K == 3072) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fa52ca5b86a2936232e8b42e2d0eda25fb91b621d::ElementAccumulator;

    typename fa52ca5b86a2936232e8b42e2d0eda25fb91b621d::Arguments arguments{
    ...
    fa52ca5b86a2936232e8b42e2d0eda25fb91b621d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_add_19 specialization."
  );
}