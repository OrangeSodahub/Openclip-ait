...
using f4eb0958e8d0a3dbbcea83202fab95f46b8cf5fea = Operation_cutlass_tensorop_h16816gemm_64x64_64x5_tn_align8;
...
void gemm_rcr_8 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 77 && N == 1536 && K == 512) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename f4eb0958e8d0a3dbbcea83202fab95f46b8cf5fea::ElementAccumulator;

    typename f4eb0958e8d0a3dbbcea83202fab95f46b8cf5fea::Arguments arguments{
    ...
    f4eb0958e8d0a3dbbcea83202fab95f46b8cf5fea gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_8 specialization."
  );
}