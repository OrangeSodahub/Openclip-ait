...
using fc18add870057b89b1ba18bfb85ab2536597b2d1d = Operation_cutlass_tensorop_h16816gemm_64x64_64x5_tn_align8;
...
void gemm_rcr_bias_19 (
 ...
 int64_t K = (*a_dim2);
  ...
  if (M == 77 && N == 512 && K == 2048) {
    
//  TODO: cast to right dtype
    using ElementComputeEpilogue = typename fc18add870057b89b1ba18bfb85ab2536597b2d1d::ElementAccumulator;

    typename fc18add870057b89b1ba18bfb85ab2536597b2d1d::Arguments arguments{
    ...
    fc18add870057b89b1ba18bfb85ab2536597b2d1d gemm_op;
  ...
  throw std::runtime_error(
      "Unsupported workload for this gemm_rcr_bias_19 specialization."
  );
}